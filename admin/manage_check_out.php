...
if($_GET['id']){
 ...
 $calc_month = abs(strtotime($date_out) - strtotime($date_in)) ; 
...
<div class="container-fluid">
	...
	<p><b>Room Price : </b><?php echo 'Rp'.number_format($cat['price'],2) ?></p>
	...
	<p><b>Days : </b><?php echo $calc_month ?></p>
	<p><b>Amount (Price) : </b><?php echo 'Rp'.number_format($cat['price'] * $calc_month ,2) ?></p>
